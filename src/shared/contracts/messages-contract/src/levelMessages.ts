export const LevelStartMessages = {
  ...
  INSTRUCTION:
    "Each level you will have to solve a puzzle to complete it. This will allow you to pass to the next level. Each level will be followed up by a quiz, all answers must be correct to continue, incorrect answers will score you negative points. You can enable skip mode and skip any level or quiz, but skipping will score you negative points.",
